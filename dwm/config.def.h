...
static const char *fonts[]          = {"LiterationMono Nerd Font:style:medium:size=12" ,"LiterationMono Nerd Font Mono:style:medium:size=19" };
...
static const Key keys[] = {
    ...
    { MODKEY,                           XK_c,       spawn,          SHCMD("chrome-no-vpn")},
